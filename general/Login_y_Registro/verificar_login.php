...
<div class="dashboard-container">
    ...
    <div class="main-content">
        ...
        <div class="candidates-section mt-4">
            <h3>Candidatos que Aplicaron (<?= count($candidatos) ?>)</h3>
            ...
            <?php else: ?>
                    ...
                    <tbody>
                        <?php foreach ($candidatos as $candidato): ?>
                            <tr>
                                ...
                                <td><?= date('d M Y', strtotime($candidato['fecha_aplicacion'])) ?></td>
                                <td>
                                ...
                                <td>
                                    <?php if ($candidato['formacion_academica'] || $candidato['experiencia_laboral'] || $candidato['habilidades']): ?>
                                        <button class="btn btn-sm btn-info"
                                            ...
                                            data-bs-target="#cvModal<?= $candidato['id_candidato'] ?>">
                                            Ver CV Digital
                                        </button>
                                    <?php else: ?>
                                        No disponible
                ...
                <!-- Modals para CV Digital -->
                <?php foreach ($candidatos as $candidato): ?>
                    <div class="modal fade" id="cvModal<?= $candidato['id_candidato'] ?>" tabindex="-1" aria-labelledby="cvModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="cvModalLabel">CV Digital de <?= htmlspecialchars($candidato['nombre'] . ' ' . $candidato['apellido']) ?></h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <?php endif; ?>
                                    <?php if (!$candidato['formacion_academica'] && !$candidato['experiencia_laboral'] && !$candidato['habilidades']): ?>
                                        <p>No hay datos de CV digital disponibles.</p>
                                    <?php endif; ?>
                                </div>
...
<!-- Incluir Bootstrap JS para los modals -->
