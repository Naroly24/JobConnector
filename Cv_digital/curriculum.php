...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Main content */
        main {
            margin-top: calc(var(--header-height) + 40px); /* Asegurar visibilidad */
            flex: 1;
            padding: 2rem 0;
        }
        ...
        .form-control {
            width: 100%;
            padding: 1rem; /* Campos más amplios */
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 0 3px rgba(0, 86, 112, 0.2); /* Ajustado para --primary */
        }
        ...
        .alert-primary {
            background-color: rgba(0, 86, 112, 0.1); /* Ajustado para --primary */
            border-left-color: var(--primary);
        }

        .alert-success {
            background-color: rgba(0, 160, 165, 0.1); /* Ajustado para --secondary */
        ...
        .table tr:hover {
            background-color: rgba(0, 86, 112, 0.05); /* Ajustado para --primary */
        }
        ...
        @media (max-width: 576px) {
            ...
            .col-6 {
                flex: 0 0 100%;
                max-width: 100%;
                padding: 0 1rem; /* Restaurar padding en pantallas pequeñas */
            }

            .form-group {
                margin-bottom: 1.5rem; /* Reducir en pantallas pequeñas */
            }
